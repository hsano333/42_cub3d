...
SRCDIR	:= ./srcs/
SRC	:= init.c arg.c hook.c mouse.c key.c close.c window.c wall.c affine.c ray.c angle_utils.c map_utils.c calc_texture_mapping.c calc_texture_mapping.c ray_utils.c 
ENTRY	:= main.c
